...
class Aplicacao {
	...
	public static void main(String args[]) {
		try {
			...
			estoque.adicionar(
					new BemDeConsumo("Leite", 4.00F, 120, LocalDateTime.now(), LocalDate.now().plusMonths(6)));
			...
			if (p.emValidade())
				JOptionPane.showMessageDialog(null, "Leite dentro da validade.", "Estoque de produtos",
						JOptionPane.INFORMATION_MESSAGE);
			else
				JOptionPane.showMessageDialog(null, "Leite esta vencido.", "Estoque de produtos",
						JOptionPane.INFORMATION_MESSAGE);
