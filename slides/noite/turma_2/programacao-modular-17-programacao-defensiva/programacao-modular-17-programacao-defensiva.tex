...
public class Aplicacao {}
  public static void main(String args[]) {
     try {
       ...
       System.err.println("Erro de estoque excedido");
       e.printStackTrace();
     } catch (ExcecaoEstoqueNegativo e) {
       System.err.println("Erro de estoque negativo");
       e.printStackTrace();
     } finally {
...
\begin{frame}[fragile]{Obrigado!!}
        ...
        \begin{block}{  }
                "\textit{O importante não é ser o primeiro ou primeira, o importante é abrir caminhos.."}
        \end{block}
\end{frame}
